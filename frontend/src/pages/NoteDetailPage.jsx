...
//               <input
//                 type="text"
//                 className="w-full px-4 py-2 border rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-primary mb-2"
...
//                   src={note.image}
//                   alt="Note preview"
//                   className="mt-2 rounded-xl max-h-48 object-cover border"
//                 />
//               )}
//             </div>
